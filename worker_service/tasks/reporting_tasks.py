...
from shared.models import User, UserStatus, RiskNotification, InteractionReport, SymptomReport, TestReport, TestType
...
def report_symptoms(self, *, user: User, task_data: SymptomReport):
    ...
    if len(positive_symptoms) >= int(env_vars['MINIMUM_SYMPTOMS']):  # notify the administrators of potential risk
